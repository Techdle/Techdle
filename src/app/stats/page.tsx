    ...
    return (
      <div className="min-h-[100dvh] font-sans">
        ...
        <main className="max-w-xl mx-auto py-8 px-4 animate-pulse">
          ...
          <div className="h-4 w-32 bg-surface-raised rounded mx-auto mb-8"></div>
          ...
          <div className="space-y-4">
            {[1,2,3,4,5,6,7].map(i => (
              <div key={i} className="flex gap-3 items-center" >
                ...
                <div className="flex-1 h-10 bg-surface rounded"></div>
              </div>
            ))}
          </div>
        </main>
  ...
  if (stats.totalPlayed === 0) {
    return (
      <div className="min-h-[100dvh] font-sans flex flex-col">
        <Header />
        <main className="flex-1 flex flex-col items-center justify-center p-4 max-w-md mx-auto text-center animate-in fade-in zoom-in duration-500">
    ...
    <div className="min-h-[100dvh] font-sans flex flex-col">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 animate-in fade-in duration-500 slide-in-from-bottom-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-12">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
            <h3 className="text-xl font-bold mb-6 text-text-main lg:text-left text-center">Guess Distribution</h3>
            <div className="space-y-4">
        ...
        {/* Heatmap History */}
        <div className="mt-12 animate-in fade-in slide-in-from-bottom-4 fill-mode-both" style={{ animationDelay: '1400ms', animationDuration: '700ms' }}>
